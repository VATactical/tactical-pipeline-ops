...
export default function TrainingPage() {
  ...
  const runAction = async (key, action, success) => { setSaving(key); setError(''); setMessage(''); try { await action(); await refresh(); setMessage(success); return true } catch (e) { setError(e.message); return false } finally { setSaving(null) } }
