...
export default function ClientsPage() {
  ...
  const submitClient = async (event) => {
    ...
    try {
      ...
      setForm({ code: '', business_name: '', legal_name: '', owner_name: '', assigned_role: 'onboarding_media', status: 'ONBOARDING' })
