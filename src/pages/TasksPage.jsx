...
function TaskComposer({ clients, onCreated, profile }) {
  ...
  return <section className="content-card task-composer"><div className="section-heading"><div><p className="eyebrow">Nueva tarea</p><h3>Asignar trabajo</h3></div></div><form onSubmit={submit}>
    ...
    <div className="composer-grid">
      ...
      <label>Prioridad<select value={form.priority} onChange={(event) => setField('priority', event.target.value)}><option value="Baja">Baja</option><option value="Media">Media</option><option value="Alta">Alta</option><option value="Urgente">Urgente</option></select></label>
