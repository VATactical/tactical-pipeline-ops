...
export default function TasksPage() {
  ...
  return <div className="page-stack">
    ...
    {profile?.id && <TaskComposer clients={clients} members={members} profile={profile} onCreated={(task) => { setTasks((current) => [task, ...current]); setMessage(t('Tarea creada y alerta enviada.')) }} />}
