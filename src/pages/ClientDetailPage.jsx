...
export default function ClientDetailPage() {
  ...
  return <div className="page-stack client-dossier-page" data-client-tab={activeTab}>
    ...
    <section className="content-card dossier-command-center client-tab-section tab-dossier">
    ...
    <div className="dossier-overview-grid client-tab-section tab-dossier">
