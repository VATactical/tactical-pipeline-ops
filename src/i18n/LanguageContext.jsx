...
const translations = {
  ...
  'Usuarios': 'Users', 'Acceso': 'Access', 'Usuarios activos': 'Active users', 'Usuarios inactivos': 'Inactive users', 'No hay usuarios inactivos.': 'There are no inactive users.', 'Los usuarios inactivos no pueden acceder. Sus tareas, notas y actividad se conservan.': 'Inactive users cannot sign in. Their tasks, notes, and activity are preserved.', 'Cerrar sesión': 'Sign out', 'Navegación principal': 'Main navigation', 'Sin rol asignado': 'No role assigned',
  ...
  'Subcuenta GHL': 'GHL sub-account',
  'Comprar número': 'Purchase phone number',
  'LeadConnector': 'LeadConnector',
  'Solicitar EIN': 'Request EIN',
  'Facebook + socio de portafolio': 'Facebook + Business Portfolio partner',
  'Método de pago en Ads y GHL': 'Payment method in Ads and GHL',
  'Dominio': 'Domain',
  'Verificar información del dossier': 'Verify dossier information',
  'Google Business Profile': 'Google Business Profile',
  'Onboarding & Media': 'Onboarding & Media',
  'Automations & Funnels': 'Automations & Funnels',
  ...
  'Nota actualizada correctamente.': 'Note updated successfully.',
  'Nota eliminada correctamente.': 'Note deleted successfully.',
  'Tarea agregada al cliente.': 'Task added to client.',
  '¿Eliminar esta tarea?': 'Delete this task?',
  'Tarea eliminada correctamente.': 'Task deleted successfully.',
  'Eliminar tarea': 'Delete task', 'Siguiente:': 'Next:', 'Sin actualización': 'No update', 'Google Docs actualizado': 'Google Docs updated',
  ...
  'Informe de fin de día': 'End-of-day report', 'Las tareas completadas se agregan automáticamente y puedes sumar trabajo manual.': 'Completed tasks are added automatically, and you can add manual work.', 'Envía un solo reporte dentro de TP OPS al finalizar tu turno. Kevin lo revisa cada mañana de 9:00 a 10:00 a. m.': 'Submit one report inside TP OPS at the end of your shift. Kevin reviews it every morning from 9:00 to 10:00 a.m.', 'Envía un reporte dentro de TP OPS al finalizar tu turno. Puedes completar cualquier día desde el lunes de esta semana hasta hoy.': 'Submit a report inside TP OPS at the end of your shift. You can complete any day from Monday of this week through today.',
  ...
  'Checklist de actividades': 'Activity checklist', 'tareas seleccionadas': 'tasks selected', 'La hora se registra automáticamente al enviarlo.': 'The time is recorded automatically when submitted.', 'Desmarca cualquier tarea que no quieras incluir en este reporte.': 'Uncheck any task you do not want to include in this report.', 'Desmarcar todas': 'Uncheck all', 'Seleccionar todas': 'Select all',
  ...
  'Tareas registradas': 'Recorded tasks', 'Trabajo adicional': 'Additional work', 'Agregar tareas manualmente': 'Add tasks manually', 'Agregar actividad manual': 'Add manual activity', 'Secciones del trabajo': 'Work sections', 'Añade cada bloque con su título, descripción y horas. El total se calcula automáticamente.': 'Add each block with its title, description, and hours. The total is calculated automatically.', 'Agregar sección': 'Add section', 'Sección': 'Section', 'Título de la sección': 'Section title', 'Horas de esta sección': 'Hours for this section', 'Actividades': 'Activities', 'Describe qué se completó, con quién o en qué clientes…': 'Describe what was completed, with whom, or for which clients…', 'Total de horas': 'Total hours', 'Resumen general del día': 'Overall daily summary', 'Resultados generales, bloqueos o contexto para supervisión…': 'Overall results, blockers, or context for supervision…', '+ Agregar': '+ Add', 'Quitar': 'Remove', 'Notas del día': 'Daily notes', 'actividades serán enviadas.': 'activities will be submitted.',
  ...
  'Cliente activo': 'Active client', 'Dossier': 'Dossier', 'Secciones del cliente': 'Client sections', 'Agregar nota': 'Add note', 'Contenido': 'Content', 'Escribe una nota específica para este cliente…': 'Write a note specific to this client…', 'Nota agregada correctamente.': 'Note added successfully.', 'Escribe un título para la nota.': 'Enter a title for the note.', 'Aún no hay notas para este cliente.': 'There are no notes for this client yet.', 'Usuario': 'User', 'notas': 'notes', 'Pendientes': 'Pending', 'Completadas': 'Completed', 'No hay tareas pendientes.': 'There are no pending tasks.', 'No hay tareas completadas.': 'There are no completed tasks.', 'Sin responsable': 'Unassigned', 'Sin fecha': 'No date', 'completadas': 'completed',
  ...
  'Tiempo manual': 'Manual time', 'Horas trabajadas': 'Hours worked', 'Registra las horas y describe el trabajo realizado.': 'Log the hours and describe the work completed.', 'Registro manual diario': 'Daily time log', 'Las horas se registran dentro del reporte EOD diario.': 'Hours are recorded within the daily EOD report.', 'Un reporte por día. Puedes completar el de ayer hasta hoy.': 'One report per day. You can complete yesterday’s report today.', 'Resumen semanal': 'Weekly summary', 'Agregar tiempo': 'Add time', 'Horas': 'Hours', 'Memo': 'Memo', 'Describe el trabajo realizado…': 'Describe the work completed…', 'Fecha': 'Date', 'Semana': 'Week', 'Agregar horas': 'Add hours', 'Agregar en este día': 'Add on this day',
  'Cada registro de tiempo necesita horas y memo.': 'Each time entry needs hours and a memo.', 'Cada sección necesita título, descripción y horas.': 'Each section needs a title, description, and hours.', 'Las horas del día no pueden superar 24.': 'Daily hours cannot exceed 24.',
  ...
  'Ver agenda': 'Calendar view', 'Mi calendario': 'My calendar', 'Editar evento': 'Edit event', 'Evento actualizado.': 'Event updated.', 'Asignar a': 'Assign to', 'Asignado a': 'Assigned to', 'Mi usuario': 'Me', 'Todo el equipo': 'Entire team',
