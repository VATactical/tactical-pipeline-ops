...
const translations = {
  ...
  'Tiempo manual': 'Manual time', 'Horas trabajadas': 'Hours worked', 'Registra horas y un memo como en el diario manual de Upwork.': 'Log hours and a memo like Upwork manual time.', 'Agregar tiempo': 'Add time', 'Horas': 'Hours', 'Memo': 'Memo', 'Describe el trabajo realizado…': 'Describe the work completed…', 'Registro tipo Upwork': 'Upwork-style time log', 'Puedes agregar horas hasta el domingo.': 'You can add hours through Sunday.', 'Semana cerrada para edición.': 'Week closed for editing.', 'Selecciona una fecha válida dentro de la semana activa.': 'Select a valid date within the active week.', 'Fecha': 'Date', 'Semana': 'Week', 'Agregar horas': 'Add hours', 'Agregar en este día': 'Add on this day',
